  ...
  describe('child handling', () => {
    ...
    describe('anchor handling', () => {
      ...
      it('should read last glyph of font', () => {
        ...
        expect(f.glyphs.last().contours.last().points.last().x()).to.be.equal(4);
        expect(f.glyphs.last().contours.last().points.last().y()).to.be.equal(40);
      });
      ...
      it('should read glyph by index', () => {
        ...
        expect(f.glyphs.get(0).contours.last().points.last().x()).to.be.equal(4);
        expect(f.glyphs.get(0).contours.last().points.last().y()).to.be.equal(40);
      });
    });
    ...
    describe('transformations', () => {
      it('should set scale a font', () => {
        ...
        expect(f.glyphs.last().contours.last().points.last().x()).to.be.equal(8);
        expect(f.glyphs.last().contours.last().points.last().y()).to.be.equal(80);
      });
      it('should move a point', () => {
        ...
        expect(f.glyphs.last().contours.get(0).points.last().x()).to.be.equal(6);
        expect(f.glyphs.last().contours.get(0).points.last().y()).to.be.equal(42);
